...
<div class="topnav" id="myTopnav">
  ...
  <a href="schedule.php"  class="active">TRAIN SCHEDULE</a>
...
<div class="train" style = "position:absolute; left:80px;top:43%;">
        <table id="table-div">
        <tbody id="tbody-id"><tr>
        <th>TRAIN NUMBER</th>
        <th>TRAIN NAME</th>
        <th>SOURCE</th>
        <th>DESTINATION</th>
...
if(isset($_POST['checkbutton'])){
  ...
  $sql="SELECT * FROM `schedule` WHERE dbsource='".$source."' AND dbdestination='".$destination."'";
...
<td>
<?php echo $r['dbtraname'];?>
</td>
<td>
<?php echo $r['dbsource'];?>
</td>
<td>
<?php echo $r['dbdestination'];?>
</td>
<td>
<?php echo $r['dbarrival'];?>
</td>
<td>
<?php echo $r['dbdept'];?>
</td>
...
<div class="container ">
    <form method="POST">
      <br><br><br><br><br>
      <label for="source" size="20">SOURCE</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      <select name="source" id="source" style="font-size:20px;"><option value="blank" style="font-size:20px;">-</option><option value="Chennai"  style="font-size:20px;">CHENNAI</option><option value="Mumbai"  style="font: size 20px;">MUMBAI</option><option value="guhati" style="font: size 20px;">GUHATI</option></select> 
      <br /><br />
      <label for="dest">DESTINATION</label>&nbsp&nbsp&nbsp
      <select name="destination" id="dest" style="font-size:20px;"><option value="blank" style="font-size:20px;">-</option><option value="hyderabad" style="font-size:20px;">HYDERABAD</option><option value="pune" style="font-size:20px;">PUNE</option><option value="kolkata"  style="font: size 20px;">KOLKATTA</option></select> 
        <br /><br />
<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<button type="submit" class="check_btn" name="checkbutton" style="font-size:20px" >
     CHECK
        </button>
...
<script>
      // Get the modal
      var modal = document.getElementById("dbid01");
