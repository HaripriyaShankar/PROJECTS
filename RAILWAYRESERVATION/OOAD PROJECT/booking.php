...
<a href="booking.php" class="active2">BOOK TICKET</a>
...
<div class="container1">
    <form method="POST" action="ticket.php">
      ...
      <label for="name">NAME</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input type="text" size="20"style="font-size:20px" name="cusname" required />
        <br /><br />
        <label for="name">AGE</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input type="text" size="20"style="font-size:20px" name="age" required />
        <br /><br />
    ...
    <option value="OTHERS">OTHERS</option></select>
        <br /><br />
        <label for="name">DATE OF BIRTH</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input type="date" size="20"style="font-size:20px" name="dob" required />
        <br /><br />
        ...
        <input type="text" size="20" style="font-size:20px" name="address" required />
        <br /><br />
        <label for="name">MOBILE NUMBER</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input type="text" size="20" style="font-size:20px" name="mobno" required />
        <br /><br />
        <label for="name">AADHAR&nbspNUMBER</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input type="integer" size="20" style="font-size:20px" name="aadhar" required />
        <br /><br />
        <label for="name">TRAIN NUMBER</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input type="integer" size="20" style="font-size:20px" name="trainno" required />
        <br /><br />
       ...
       <select name="classtrain" id="train-class" style="font-size: 18px;"><option value="AC FIRST CLASS">AC FIRST CLASS</option><option value="FIRST CLASS">FIRST CLASS</option><option value="SLEEPER">SLEEPER</option></select>
        <br /><br><br><br>
